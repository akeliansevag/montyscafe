        <footer class="movable-container mt-9 mb-5">
            <section class="d-flex align-items-center justify-content-center">
                <div class="position-absolute top-0 w-100 pill">
                    <div>
                        <div class="position-absolute top-0 d-flex justify-content-center align-items-center w-100 h-100 z-1">
                            <div class="container">
                                <h1 class="fs-1 text-center primary-color">Let's get in touch</h1>
                                <div class="text-center d-flex align-items-center justify-content-center social-icons pt-3">
                        ...
                        <div class="position-absolute bottom-0 start-0 d-flex justify-content-center align-items-end w-100 h-100 mb-3">
                            <div class="container white-color text-center">
                                <p>All rights reserved © Monty’s Café - 2023</p>
                            </div>
                        </div>
                    </div>
                </div>
